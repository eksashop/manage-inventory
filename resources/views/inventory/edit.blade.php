    ...
    <div class="py-12 bg-slate-950 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h2 class="text-3xl font-bold text-white tracking-tight">Edit <span class="text-blue-500 text-shadow-neon">Produk</span></h2>
                    <p class="text-gray-400 mt-1 text-sm">Perbarui informasi barang di sistem Eksa Framework.</p>
                </div>
